...
INSERT INTO `AdminLogs` VALUES (1,6,'UPDATE_ROLE','Role updated to BusinessLogicAdmin for user ID 1','2025-05-12 11:36:55'),(2,3,'CREATE_FRIDGE','Fridge Samsung Model X 4500 додано в локацію Kitchen','2025-05-12 13:54:53'),(3,6,'RESTORE_DB','База даних відновлена з резервної копії: E:/Навчання/АПЗ/FRIDGE_SYSTEM_PROJECT/fridge-system/backups/backup_1747082147051.sql','2025-05-12 20:57:48'),(4,6,'MANAGE_ACCESS','Надано доступ до бази даних fridge_system для користувача new_user з роллю SELECT, INSERT','2025-05-12 21:10:23'),(5,6,'UPDATE_ROLE','Role updated to ServiceAdmin for user ID 1','2025-05-12 22:05:54');
...
INSERT INTO `AlgorithmSettings` VALUES (1,'MaxRetries','50','Maximum number of retry attempts for the algorithm','2025-05-12 21:55:55'),(2,'Timeout','30','Timeout duration for algorithm execution in seconds','2025-05-12 21:55:55'),(3,'CacheSize','1024','Maximum size of the cache for algorithm data','2025-05-12 21:55:55'),(4,'EnableLogging','true','Enable or disable logging for the algorithm','2025-05-12 21:55:55'),(5,'ThresholdLimit','75','Threshold limit for processing tasks','2025-05-12 21:55:55');
...
INSERT INTO `Configurations` VALUES (1,'MAX_STORAGE_LIMIT','600','Maximum storage limit for products','2025-05-12 03:04:26','2025-05-12 21:13:24'),(2,'API_TIMEOUT','30','Timeout for API requests in seconds','2025-05-12 03:04:26','2025-05-12 03:04:26'),(3,'REPORT_GENERATION_ENABLED','true','Enable or disable report generation','2025-05-12 03:04:26','2025-05-12 03:04:26');
...
INSERT INTO `NotificationRules` VALUES (1,'Low Stock Alert','stock < 10','Send Email to Manager','2025-05-12 21:20:05','2025-05-12 21:20:05'),(2,'High Temperature Warning','temperature > 30','Trigger Cooling System','2025-05-12 21:20:05','2025-05-12 21:20:05'),(3,'High Temperature Alert','temperature > 30','Send Email to Admin','2025-05-12 21:20:05','2025-05-12 21:46:37'),(4,'Low Temperature Warning','temperature < 5','Send SMS to Admin','2025-05-12 21:43:05','2025-05-12 21:43:05');
...
-- Dump completed on 2025-05-12 22:49:52
